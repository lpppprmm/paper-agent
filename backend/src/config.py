...
# Load .env from the backend project root (works when running from backend/ or backend/src/)
...
class Configuration(BaseModel):
    ...
    min_evidence_per_argument: int = Field(
        default=2,
        title="Min Evidence Per Argument",
        description="论文论点低于该证据来源数时触发补充检索（More Research）",
    )
